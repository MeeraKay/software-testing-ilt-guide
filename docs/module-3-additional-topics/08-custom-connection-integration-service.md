...
!!! example "Step 6  Connect"
    1. Return to your connector in Integration Service
    2. Use the retrieved token to authenticate and establish the connection.

---

[Next → Additional Agentic Features](09-other-agentic-features.md){: .md-button .md-button--primary}
