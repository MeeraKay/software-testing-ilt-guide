...
![Run Test](../assets/images/Run.png)
...
![Tear Down](../assets/images/Tear%20down.jpg)

## Customizing the template

✅ In the Data folder, open `Assets.json` and add the Orchestrator assets you need. 

![Customizing the Template](../assets/images/Customize%20templ.jpg)


!!! note
    Use `Assets.json` for any asset type except credentials — for Orchestrator credential assets, add them as a Constant instead.


✅ In Data Manager, under Constants, add the credential assets you want to use, and access them with a Get Credential activity. 

!!! note 
    If the credential asset lives in a different Orchestrator folder than the one where the process runs, create another Constant to store the folder name.
...
[Next → Terminal Testing](04-terminal-testing.md){: .md-button .md-button--primary}
