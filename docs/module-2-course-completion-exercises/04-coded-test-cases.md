...
📄 See the <a href="https://docs.uipath.com" target="_blank">UiPath Studio User Guide</a> to learn more about using activity packages in coded automations.

---

[Next → Additional Exercises](05-additional-exercises.md){: .md-button .md-button--primary}
